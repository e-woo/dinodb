...
export const createClub = async (req, res) => {
    const { ucid, activityType, name, description, schedule, img, interview, application, weekHours, tags, facultyType, fee, discord, instagram, perks } = req.body;
...
export const editClub = async (req, res) => {
    const { id, name, description, schedule, img, interview, application, weekHours, tags, facultyType, fee, discord, instagram, perks } = req.body;
